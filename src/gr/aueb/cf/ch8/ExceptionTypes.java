...
public class ExceptionTypes {
     ...
     * to be explicitly to be thrown in method isgnature.
     * Or has to be caught {}
     ...
     * in method signature. And thee exception not propagates.
     ...
     * we take action -- logging, and also rethrow the exception
